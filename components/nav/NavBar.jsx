...
function NavBar() {
  ...
  return (
    <div className=" n">
        <div className="n-logo-wrapper"><Link href="/"><RotLogo/></Link></div>
        <ul className="n-links">
          <li className="n-link"><Link href="/"><Button variant="swipeGrad lightgreen">Home</Button></Link></li>
            <li className="n-link"><Link href="/innov8Learn"><Button variant="swipeGrad lightgreen">Innov8Learn</Button></Link></li>
    ...
    <Link href="/innov8Learn"><li>Innov8Learn</li></Link>
